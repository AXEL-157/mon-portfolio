...
with sync_playwright() as p:
    ...
    page.goto("https://www.burgerkingreunion.re/carte/burgers",  wait_until="domcontentloaded")
    ...
    for menu in menus:
        ...
        page.wait_for_selector("div.MuiStack-root.mui-y1xhs3, div.MuiStack-root.mui-z9sn5b")
        menu_textes = page.locator("div.MuiStack-root.mui-y1xhs3 p, div.MuiStack-root.mui-z9sn5b p").all_text_contents()
        descriptions = []
...
with open("burger.json", "w", encoding="utf-8") as f:
