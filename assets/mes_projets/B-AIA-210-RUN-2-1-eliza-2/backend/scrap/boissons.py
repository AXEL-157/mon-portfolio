...
with sync_playwright() as p:
    ...
    page.goto("https://www.burgerkingreunion.re/carte/boissons",  wait_until="domcontentloaded")
    ...
    for menu in menus:
        ...
        page.wait_for_selector("div.MuiStack-root.mui-1b2qzsm")
        menu_textes = page.locator("div.MuiStack-root.mui-1b2qzsm p").all_text_contents()
        descriptions = []
...
with open("boissons.json", "w", encoding="utf-8") as f:
